...
public class TestCondottiere {
	...
	public void test2() {
		...
		q = new Quartier("hotel de ville",Quartier.TYPE_QUARTIERS[3],5); pioche.ajouter(q);
		q = new Quartier("bibliothéque",Quartier.TYPE_QUARTIERS[4],6,"Si vous choisissez..."); 
		pioche.ajouter(q);
		pioche.melanger();
	...
	public void test3() {
		...
		Test.test(condottiere.getJoueur().nbPieces() == 3,
			"test du nombre de pièces d'or apr�s perception de ressources sp�cifiques avec 1 quartier militaire");
	}
}
